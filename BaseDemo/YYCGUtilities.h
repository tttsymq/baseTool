...
CGContextRef _Nullable byCGContextCreateARGBBitmapContext(CGSize size, BOOL opaque, CGFloat scale);

/// Create a `DeviceGray` Bitmap context. Returns NULL if an error occurs.
CGContextRef _Nullable byCGContextCreateGrayBitmapContext(CGSize size, CGFloat scale);



/// Get main screen's scale.
CGFloat byScreenScale(void);

/// Get main screen's size. Height is always larger than width.
CGSize byScreenSize(void);
 ...
 */
CGAffineTransform byCGAffineTransformGetFromPoints(CGPoint before[_Nullable 3], CGPoint after[_Nullable 3]);

/// Get the transform which can converts a point from the coordinate system of a given view to another.
//CGAffineTransform byCGAffineTransformGetFromViews(UIView *from, UIView *to);
...
UIViewContentMode byCAGravityToUIViewContentMode(NSString *gravity);

/// Convert UIViewContentMode to CALayer's gravity string.
NSString *byUIViewContentModeToCAGravity(UIViewContentMode contentMode);
 ...
 */
CGRect byCGRectFitWithContentMode(CGRect rect, CGSize size, UIViewContentMode mode);
...
// main screen's scale
#ifndef kScreenScale
#define kScreenScale byScreenScale()
#endif

// main screen's size (portrait)
#ifndef kScreenSize
#define kScreenSize byScreenSize()
#endif

// main screen's width (portrait)
#ifndef kScreenWidth
#define kScreenWidth byScreenSize().width
#endif

// main screen's height (portrait)
#ifndef kScreenHeight
#define kScreenHeight byScreenSize().height
#endif
